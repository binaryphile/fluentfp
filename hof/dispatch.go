...
func Dispatch2[A, B, C any](f func(A) B, g func(A) C) func(A) (B, C) {
	if f == nil {
		panic("hof.Dispatch2: f must not be nil")
	}
	if g == nil {
		panic("hof.Dispatch2: g must not be nil")
	}
...
func Dispatch3[A, B, C, D any](f func(A) B, g func(A) C, h func(A) D) func(A) (B, C, D) {
	if f == nil {
		panic("hof.Dispatch3: f must not be nil")
	}
	if g == nil {
		panic("hof.Dispatch3: g must not be nil")
	}
	if h == nil {
		panic("hof.Dispatch3: h must not be nil")
	}
