...
func TestWithAndFrom(t *testing.T) {
	...
	got, ok := ctxval.From[RequestID](ctx).Get()
...
func TestFromAbsent(t *testing.T) {
	_, ok := ctxval.From[RequestID](context.Background()).Get()
...
func TestWithShadowsParent(t *testing.T) {
	...
	got, ok := ctxval.From[RequestID](child).Get()
...
func TestDistinctNamedTypes(t *testing.T) {
	...
	reqID, reqOK := ctxval.From[RequestID](ctx).Get()
	trID, trOK := ctxval.From[TraceID](ctx).Get()
...
func TestNilInterfaceValuePresent(t *testing.T) {
	...
	got, ok := ctxval.From[io.Reader](ctx).Get()
...
func TestInterfaceVsConcreteType(t *testing.T) {
	...
	_, readerOK := ctxval.From[io.Reader](ctx).Get()
	if !readerOK {
		t.Fatal("From[io.Reader] should find the value")
	}

	_, bufOK := ctxval.From[*bytes.Buffer](ctx).Get()
	if bufOK {
...
func TestValueVsPointerType(t *testing.T) {
	...
	_, valOK := ctxval.From[User](ctx).Get()
	if !valOK {
		t.Fatal("From[User] should find the value")
	}

	_, ptrOK := ctxval.From[*User](ctx).Get()
	if ptrOK {
...
func TestNonComparableTypeParameter(t *testing.T) {
	...
	got, ok := ctxval.From[[]byte](ctx).Get()
...
func TestAnyTypeParameter(t *testing.T) {
	...
	got, ok := ctxval.From[any](ctx).Get()
...
func TestTypeAliasCollides(t *testing.T) {
	...
	got, ok := ctxval.From[string](ctx).Get()
...
func TestKeyDoesNotCollideWithTypeKeyed(t *testing.T) {
	...
	typeKeyed, _ := ctxval.From[string](ctx).Get()
