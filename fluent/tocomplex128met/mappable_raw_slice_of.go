...
// ToComplex128s applies the provided function to each element of the slice, mapping it to a Slice of type complex128.
func (ts MappableRawSliceOf[T, R]) ToComplex128s(fn func(T) complex128) MappableSliceOf[complex128, R] {
	return Map(ts, fn)
}
