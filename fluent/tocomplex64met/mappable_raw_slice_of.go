...
// ToComplex64s applies the provided function to each element of the slice, mapping it to a Slice of type complex64.
func (ts MappableRawSliceOf[T, R]) ToComplex64s(fn func(T) complex64) MappableSliceOf[complex64, R] {
	return Map(ts, fn)
}
