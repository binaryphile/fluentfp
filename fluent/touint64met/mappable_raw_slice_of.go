...
// ToUint64s applies the provided function to each element of the slice, mapping it to a Slice of type uint64.
func (ts MappableRawSliceOf[T, R]) ToUint64s(fn func(T) uint64) MappableSliceOf[uint64, R] {
	return Map(ts, fn)
}
