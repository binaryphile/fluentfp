...
// ToFloat32s applies the provided function to each element of the slice, mapping it to a Slice of type float32.
func (ts MappableRawSliceOf[T, R]) ToFloat32s(fn func(T) float32) MappableSliceOf[float32, R] {
	return Map(ts, fn)
}
