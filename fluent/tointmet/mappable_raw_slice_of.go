...
// ToInts applies the provided function to each element of the slice, mapping it to a Slice of type int.
func (ts MappableRawSliceOf[T, R]) ToInts(fn func(T) int) MappableSliceOf[int, R] {
	return Map(ts, fn)
}
