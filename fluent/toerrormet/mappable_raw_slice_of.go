...
// ToErrors applies the provided function to each element of the slice, mapping it to a Slice of type error.
func (ts MappableRawSliceOf[T, R]) ToErrors(fn func(T) error) MappableSliceOf[error, R] {
	return Map(ts, fn)
}
