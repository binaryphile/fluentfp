...
// ToInt64s applies the provided function to each element of the slice, mapping it to a Slice of type int64.
func (ts MappableRawSliceOf[T, R]) ToInt64s(fn func(T) int64) MappableSliceOf[int64, R] {
	return Map(ts, fn)
}
