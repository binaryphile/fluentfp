...
// ToUintptrs applies the provided function to each element of the slice, mapping it to a Slice of type uintptr.
func (ts MappableRawSliceOf[T, R]) ToUintptrs(fn func(T) uintptr) MappableSliceOf[uintptr, R] {
	return Map(ts, fn)
}
