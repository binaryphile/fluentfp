...
// ToFloat64s applies the provided function to each element of the slice, mapping it to a Slice of type float64.
func (ts MappableRawSliceOf[T, R]) ToFloat64s(fn func(T) float64) MappableSliceOf[float64, R] {
	return Map(ts, fn)
}
