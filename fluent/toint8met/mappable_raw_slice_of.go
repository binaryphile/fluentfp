...
// ToInt8s applies the provided function to each element of the slice, mapping it to a Slice of type int8.
func (ts MappableRawSliceOf[T, R]) ToInt8s(fn func(T) int8) MappableSliceOf[int8, R] {
	return Map(ts, fn)
}
