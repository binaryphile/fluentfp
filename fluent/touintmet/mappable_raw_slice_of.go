...
// ToUints applies the provided function to each element of the slice, mapping it to a Slice of type uint.
func (ts MappableRawSliceOf[T, R]) ToUints(fn func(T) uint) MappableSliceOf[uint, R] {
	return Map(ts, fn)
}
