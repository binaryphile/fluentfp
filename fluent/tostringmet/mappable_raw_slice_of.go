...
// ToStrings applies the provided function to each element of the slice, mapping it to a Slice of type string.
func (ts MappableRawSliceOf[T, R]) ToStrings(fn func(T) string) MappableSliceOf[string, R] {
	return Map(ts, fn)
}
