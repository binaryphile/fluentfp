...
// ToUint32s applies the provided function to each element of the slice, mapping it to a Slice of type uint32.
func (ts MappableRawSliceOf[T, R]) ToUint32s(fn func(T) uint32) MappableSliceOf[uint32, R] {
	return Map(ts, fn)
}
