...
// ToAnys applies the provided function to each element of the slice, mapping it to a Slice of type any.
func (ts MappableRawSliceOf[T, R]) ToAnys(fn func(T) any) MappableSliceOf[any, R] {
	return Map(ts, fn)
}
