...
// ToUint16s applies the provided function to each element of the slice, mapping it to a Slice of type uint16.
func (ts MappableRawSliceOf[T, R]) ToUint16s(fn func(T) uint16) MappableSliceOf[uint16, R] {
	return Map(ts, fn)
}
