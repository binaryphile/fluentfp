...
// ToBytes applies the provided function to each element of the slice, mapping it to a Slice of type byte.
func (ts MappableRawSliceOf[T, R]) ToBytes(fn func(T) byte) MappableSliceOf[byte, R] {
	return Map(ts, fn)
}
