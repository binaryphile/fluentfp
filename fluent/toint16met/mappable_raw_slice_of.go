...
// ToInt16s applies the provided function to each element of the slice, mapping it to a Slice of type int16.
func (ts MappableRawSliceOf[T, R]) ToInt16s(fn func(T) int16) MappableSliceOf[int16, R] {
	return Map(ts, fn)
}
